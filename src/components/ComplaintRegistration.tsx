    ...
    reader.onloadend = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:3000/analyze-image', {
                ...
                body: JSON.stringify({ imageData: base64data, issueType: formData.issueType }),
            });
            ...
            toast({
                ...
                description: err.message || "Could not analyze the image. Please write a description manually.",
                variant: "destructive"
            });
        } finally {
